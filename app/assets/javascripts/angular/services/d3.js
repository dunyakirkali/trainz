trainzApp.service('D3Service', function () {
  ...
  d3Service.drawPath = function() {
    ...
    this.vis.append("svg:g").attr("class", "route").selectAll("path").data(this.json.features).enter().append("svg:path")
        .attr("d", this.path).attr("stroke", "#333").attr("fill", "#EBEFF2");
    
  };
  
  d3Service.addCircles = function() {
  ...
  d3Service.drawCircles = function(t) {
    for(var i = 0; i < this.carriages.length; i++) {
      this.circles[i].attr({
